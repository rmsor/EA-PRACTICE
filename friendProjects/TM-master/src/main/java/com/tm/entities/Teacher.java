...
@NamedQueries({
    ...
    @NamedQuery(name = "Teacher.findByContactNumber", query = "SELECT t FROM Teacher t WHERE t.contactNumber = :contactNumber"),
    ...
    @NamedQuery(name = "Teacher.findByIsDeleted", query = "SELECT t FROM Teacher t WHERE t.isDeleted = :isDeleted")})
