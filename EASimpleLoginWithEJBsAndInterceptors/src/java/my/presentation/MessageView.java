...
public class MessageView implements Serializable
{
    ...
    public String postMessage(){
      ...
      /*to be done -- hook together the sent and rcv messages 
      
      System.out.println("MessageView about to save the user to DB");
      //first check if the user already exists
      
      myUser = myUserFacade.findUserByEmail(myUserName);
      if (myUser == null){
          //this is  new user -- do a create
          System.out.println("MessageView creating new user DB");
          myUser = new User();
          myUser.setEmailAddress(myUserName);
          myUser.setPassword(myUserName);
